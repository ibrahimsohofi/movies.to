          ...
          <form onSubmit={handleSubmitReview} className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder={fallbackMode ? 'Share your thoughts (saved locally)...' : 'Share your thoughts about this movie...'}
                required
              />
            </div>
            ...
            {fallbackMode && (
              <p className="text-xs text-muted-foreground">Posting anonymously (local mode).</p>
            )}
          </form>
        </CardContent>
      </Card>
