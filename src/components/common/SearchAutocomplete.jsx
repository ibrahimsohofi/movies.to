      ...
      <form onSubmit={handleSubmit}>
        <div className="relative group">
          ...
          <Input
            ...
            className="pl-10 bg-muted/50 border-border/50 focus:bg-background focus:border-red-600/50 focus:ring-red-600/20 transition-all duration-300 hover:bg-muted/70"
          />
        </div>
      </form>
              ...
              {suggestions.map((movie, index) => (
                <button
                  ...
                  className={`w-full flex items-center gap-3 p-2 hover:bg-muted rounded-md transition-colors text-left ${
                    selectedIndex === index ? 'bg-red-50 border-red-500/50' : ''
                  }`}
                >
