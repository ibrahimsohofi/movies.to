...
export default function Watch() {
  ...
  return (
    <>
      ...
      <div className={`bg-gradient-to-b from-zinc-900 via-zinc-900 to-black pb-4 ${isTheaterMode ? 'relative z-50' : ''}`}>
        <div ref={containerRef} className={`relative ${isTheaterMode ? 'max-w-7xl mx-auto px-4 pt-4' : 'w-full max-w-[1800px] mx-auto px-2 sm:px-4'}`}>
          ...
          {/* Video Player Section - FIXED: Better responsive height */}
          <div className={`relative w-full bg-black rounded-xl overflow-hidden shadow-2xl ${
            isFullscreen
              ? 'fixed inset-0 z-50 rounded-none'
              : isTheaterMode
                ? 'aspect-video max-h-[85vh]'
                : 'aspect-video min-h-[300px] sm:min-h-[400px] md:min-h-[450px] lg:min-h-[500px] xl:min-h-[550px]'
          }`}>
