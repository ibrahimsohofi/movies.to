...
export default function Login() {
      ...
      try {
        ...
        if (data?.results?.length > 0) {
          ...
          if (moviesWithBackdrop.length > 0) {
            // Pick a random movie from the top 5
  ...
  return (
    <div className="w-full py-8 md:py-12 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-red-500/20 via-transparent to-pink-500/20 animate-gradient-shift pointer-events-none"></div>
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_120%,rgba(239,68,68,0.15),transparent_50%)] pointer-events-none"></div>

      <Card className="w-full max-w-md mx-4 relative z-10 backdrop-blur-md bg-background/80 shadow-2xl border-red-500/20 hover:border-red-500/40 transition-all duration-500 animate-in fade-in slide-in-from-bottom-4">
