...
import { User, Calendar, MapPin, Film, TrendingUp, ImageIcon, ExternalLink, Instagram, Twitter, Facebook, ChevronUp } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div className="min-h-screen">
        ...
        <button
          onClick={scrollToTop}
          className={`fixed bottom-6 right-6 z-50 p-3 rounded-full bg-red-600 text-white shadow-lg hover:bg-red-700 transition-all duration-300 ${
