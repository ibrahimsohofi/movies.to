  ...
  return (
    <div className="container mx-auto px-4 py-8 min-h-screen">
      ...
      <div className="mb-8 animate-slide-in-up">
        ...
        <p className="text-muted-foreground mb-6">Discover your next favorite film</p>
          ...
          <div className="flex items-center gap-3 flex-wrap">
            <p className="text-muted-foreground text-lg">
              {loading ? (
                ...
                <>
                  Found <span className="font-bold text-red-600">{movies.length}</span> results for <span className="font-semibold text-foreground">"{query}"</span>
                </>
              )}
            </p>
          </div>
